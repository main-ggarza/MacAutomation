...
scriptLog="${4:-"/var/log/com.telesign.log"}"                                   # Parameter 4: Script Log Location [ /var/log/org.churchofjesuschrist.log ] (i.e., Your organization's default location for client-side logs)
...
presetConfiguration="${11:-"Catch-all"}"                                        # Parameter 11: Specify a Configuration (i.e., `policyJSON`; NOTE: If set, `promptForConfiguration` will be automatically suppressed and the preselected configuration will be used instead)
...
buildingsListRaw="APAC (Asia - Pacific),EMEA (Europe - Middle East and Africa),LATAM (Latin America),NA (North America - USA and Canda Only)"
...
supportTeamName="Corporate IT"
#supportTeamPhone="+1 (801) 555-1212"
supportTeamEmail="helpme@telesign.com"
...
welcomeMessage="Please enter the **required** information that ${supportTeamName} is requesting for your ${modelName}. The fundamental configuration settings will commence the application process on your ${modelName}. \n\nOnce completed, the **Wait** button will be enabled and you‘ll be able to review the results before restarting your ${modelName}.  \n\nIf you need assistance, please contact the ${supportTeamName} via \n${supportTeamEmail} or in our Slack Channel **#ask-helpdesk**.  \n\n---"
...
function policyJSONConfiguration() {
    ...
    case ${symConfiguration} in
        ...
        "${configurationThreeName}" )
            ...
            '
            ;;
##     This is the configuration that we are forcing to use, with the name of "Complated". We force this configuration in line 81.   
##     The name of configurationThreeName is set in line 181. Which you will see reflected in line 81.
##     This will vefiy that our baseline is installed. It checks .plist of each app if it comes to true, it will show as installed. 
            ...
            policyJSON='
              {
            	"steps": [{
            		...
            		},
            		{
            			...
            			"progresstext": "Use Palo Alto GlobalProtect to establish a Virtual Private Network (VPN) connection to Telesign.",
            			"trigger_list": [{
            		...
            		},
            		{
            			...
            			"icon": "f6424b9c2ba3a16f6f5e809cd7cc59f8b3be3dcdc86c5586e112762483138a73",
            			"progresstext": "CrowdStrike Falcon is a cloud-native endpoint protection platform that uses artificial intelligence to detect, prevent, and respond to cybersecurity threats across Telesign devices and endpoints..",
            			"trigger_list": [{
            				"trigger": "crowdstrike",
            		...
            		},                      
            		{
            			...
            			"progresstext": "Slack is like a digital office where we chat, collaborate, and keep work organized with different 'channels' for topics and projects.",
            			"trigger_list": [{
            				"trigger": "slack",
            		...
            		},                    
      		        {
            			...
            			"icon": "336b0382b07dc4273465dfaf15d2e529427c1199c4e73cf77ed6f7ccbd2847a3",
            			"progresstext": "Microsoft Office 365 for Mac gives you the essentials to get it all done with the classic versions of the Office applications.",
            			"trigger_list": [{
            				"trigger": "microsoftonedrive",
            				"validation": "/Applications/OneDrive.app/Contents/Info.plist"
            			}]
            		},
            		{
            			"listitem": "Microsoft OneNote",
            			"icon": "a10ac257accff5479d467cf0c8f148559b92eb0ccb7c78f80464901532c95bdb",
            			"trigger_list": [{
            				"trigger": "microsoftonenote",
            				"validation": "/Applications/Microsoft OneNote.app/Contents/Info.plist"
            			}]
            		},                 
            		{
            			"listitem": "Microsoft Outlook",
            			"icon": "e35dca1a90fc63b6a08c9cf8f74de8309bdea81c393065a130a65d9e5d75ac70",
            			"progresstext": "Microsoft Office 365 for Mac gives you the essentials to get it all done with the classic versions of the Office applications.",
            			"trigger_list": [{
            		...
            		{
            			"listitem": "Zoom",
            			"icon": "ae960c2225ca0c0990285193453092d9d64ab0de66b8fc6b86bb2f3de6f273dd",
            			"progresstext": "Zoom is a video conferencing platform that allows people to hold virtual meetings and webinars with features like video, audio, screen sharing, and chat.",
            			"trigger_list": [{
            				"trigger": "zoom",
            		...
            		{
            			"listitem": "Deleting Icons",
            			"icon": "94b23e2231e059235167a80ad4b1ad76a35fe9b5204898dec4aef7f0267faebf",
            			"progresstext": "We are removing all the icons from your dock, do not worry, you can add them back if you want.",
            			"trigger_list": [{
            				"trigger": "removeicons",
            				"validation": "None"
            			}]
            		...
            		{
            			"listitem": "Computer Name Configuration",
            			"icon": "e3984e0b630282c29e3fe4dd13d88412c95828cd4ea44b7d0db8e849dd3a3ed9",
            			"progresstext": "Verifying Computer Name.",
            			"trigger_list": [{
            				"trigger": "changecomputer",
            				"validation": "none"
            			}]
            		},                      
            		{
